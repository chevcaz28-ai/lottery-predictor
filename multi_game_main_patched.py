...
def open_sheet() -> gspread.Spreadsheet:
    ...
    json_creds = os.getenv("GCP_SERVICE_ACCOUNT_JSON") or os.getenv("GOOGLE_CREDS_JSON")
    if not json_creds:
        raise EnvironmentError("GCP_SERVICE_ACCOUNT_JSON (or GOOGLE_CREDS_JSON) must be set")
