...
def main():
    ...
    for game in games:
        ...
        # Also record these picks into the Prediction_Tracker tab so win counts
        # can be evaluated later.  This does not affect the main generation
        # logic and mirrors legacy behavior where the tracker served as a
        # consolidated log of all predictions.  If the tracker sheet is
        # unavailable or disabled, this call silently no-ops.
